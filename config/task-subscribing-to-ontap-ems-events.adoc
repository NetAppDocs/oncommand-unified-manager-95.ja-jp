...
+
https://kb.netapp.com/Advice_and_Troubleshooting/Data_Infrastructure_Management/OnCommand_Suite/How_to_configure_ONTAP_EMS_Event_Subscriptions_in_OnCommand_Unified_Manager_%2F%2F_Active_IQ_Unified_Manager["OnCommand Unified Manager / Active IQ Unified Manager でONTAP EMSイベントサブスクリプションを設定する方法"]
